...
// // Global Variables
// unsigned char prevRBTN = 0;
// unsigned char prevLBTN = 0;
...
// // Horn Sound
// const uint16_t horn_sound[] = { NOTE_E4 };
// const uint8_t horn_duration[] = { 5 };
...
// const unsigned long Blinker_Period = 400;//TODO:Set the GCD Period
// const unsigned long Horn_Period = 300;
...
//     static uint8_t moveTick = 0;
//     uint8_t obstacleSpeed = 0;
//     static uint8_t prevCarY = 1;
//     static uint8_t prevObstacleX = 0;
...
//             clear_char(prevCarY, carX);
//             clear_char(1, prevObstacleX);

//             // obstacle speed
//             moveTick++;
//             if (moveTick >= obstacleSpeed) {
//                 moveTick = 0;
//                 if (obstacleSpeed == 0) {
//                     obstacleX = 15;
//                 }
...
//     serial_println(revVAL);

//     switch(state) { // Transisitions
//         case revIDLE:
//             if (!usedRev && GAMEON && revVAL > 900) {
//                 usedRev = true;
//                 revTimer = 30;
//                 revving = true;
//                 score += 20;
